---
id: 7
title: Brand Manual for German News Media Brand
subtitle: My Brand Guidelines for WELT
slug: brand-manual
...
- precise logo usage and edge cases
- color logic across print, screen, and broadcast
- typography rules that scale from headlines to UI
- naming conventions and writing style across products
- a structured product-logo ecosystem

![/assets/welt-brand/BM.jpg]

# From rules to a usable system
...
```font name="Mark OT" styles="Medium, SemiBold, Bold" bgColor="#F5F5F7" color="#428ce5"
```

# Naming is part of the brand
...
```mockup type="macbook" image="/assets/welt-brand/230413_WELT_Brand Manual-_Seite_20.jpg" bgColor="#F5F5F7"
```
...
# Motion Guidelines for TV Interfaces
More to share soon!