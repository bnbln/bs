...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // Handle window resize - teardown and show plain text
  ...
  return React.createElement(Tag, { ref: ref as React.Ref<HTMLElement>, className: classes, style: commonStyle } as any, text);
};
